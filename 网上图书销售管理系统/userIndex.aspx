<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userIndex.aspx.cs" Inherits="网上图书销售管理系统.userIndex" %>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right hidden-sm">
                ...
                <li><asp:Button ID="Button3" runat="server" class="btn btn-info" Text="搜索" OnClick="Button_Search_Click"/></li>                
                <li>
...
<div class="container">
    ...
    <div class="card">
                ...
                <div class="row">
                    <asp:DataList ID="DataList1" runat="server" DataKeyField="bookid" DataSourceID="SqlDataSource1" RepeatColumns="4" CssClass="table table-bordered" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Both">
                        ...
                        <ItemTemplate>
                            ...
                            <br />
                            <a href="userBookDetail.aspx?bookid=<%# Eval("bookid") %>" class="btn btn-info btn-block" >查看详情</a>
                        </ItemTemplate>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row">
                    <asp:DataList ID="DataList2" runat="server" DataKeyField="bookid" DataSourceID="SqlDataSource2" CssClass="table table-bordered" RepeatColumns="4" RepeatDirection="Horizontal">
                        <ItemTemplate>
                           <asp:Image ID="Image1" runat="server" src='<%# Eval("imagesUrl") %>' style="width:100px;height:100px;"/>
                            <br/>
                            图书名:
