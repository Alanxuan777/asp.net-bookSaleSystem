<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userAllbook.aspx.cs" Inherits="网上图书销售管理系统.userAllbook" %>
...
<div class="container">
    ...
    <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered table-condensed" runat="server" AutoGenerateColumns="False" DataKeyNames="bookid" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="bookid" DataNavigateUrlFormatString="userBookDetail.aspx?bookid={0}" HeaderText="购买" Text="购买" />
