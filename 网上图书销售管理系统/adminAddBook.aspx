<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminAddBook.aspx.cs" Inherits="网上图书销售管理系统.adminAddBook" %>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
		  ...
		  <a class="dropdown-item active" href="adminAddBook.aspx">添加图书</a>
       ...
       <form runat="server"  class = "m-auto">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="adminAddBook.aspx">添加图书</a>
          </li>
        ...
        <!-- Page Content -->
            <div class="input-group mb-3 justify-content-center" >
             <div class="input-group-prepend col-md-3">
              ...
              <asp:TextBox ID="TextBox_bookid" class="form-control" runat="server"></asp:TextBox>
             </div>
             <div class="input-group-prepend col-md-3">
           ...
           <div class="input-group mb-3 justify-content-center" >
             <div class="input-group-prepend col-md-3">
              ...
              <asp:TextBox ID="TextBox_type" class="form-control" runat="server"></asp:TextBox>
             </div>
             <div class="input-group-prepend col-md-3">
           ...
           <div class="input-group mb-3 justify-content-center" >
             ...
             <div class="input-group-prepend col-md-3">
                 <asp:FileUpload ID="FileUpload1" runat="server" class="input-group-text" BackColor="White" BorderStyle="None" Width="300px" />
                 <asp:Button ID="btnLoad" runat="server" Text="上传图片" class="btn btn-primary " OnClick="btnLoad_Click"/>
             </div>
            </div>
           <div class="input-group mb-3 justify-content-center">
                  <asp:Button ID="Button_add" class="btn btn-primary col-md-2 m-4" runat="server" Text="添加" OnClick="Button_add_Click"   /> 
