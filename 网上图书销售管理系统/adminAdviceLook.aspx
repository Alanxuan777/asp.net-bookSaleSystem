<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminAdviceLook.aspx.cs" Inherits="网上图书销售管理系统.adminAdviceLook" %>
    ...
    <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
      ...
      <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
          <a class="dropdown-item active" href="adminAdviceLook.aspx">意见箱</a>
        </div>
      </li>
      ...
      <div class="container-fluid">
       ...
       <form runat="server"  class = "m-auto">
          ...
          <li class="breadcrumb-item">
            <a href="adminAdviceLook.aspx">意见箱</a>
          </li>
            <li class="breadcrumb-item active">Advice Look</li>
           ...
           <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="count" DataSourceID="SqlDataSource1" >
               <Columns>
                   ...
                   <asp:BoundField DataField="advice_text" HeaderText="留言内容" SortExpression="advice_text" />
                   <asp:HyperLinkField HeaderText="回复" Text="回复" DataNavigateUrlFields="count,uid,advice_text" DataNavigateUrlFormatString="adminAdviceHuifu.aspx?count={0}&uid={1}&advice_text={2}"/>
               </Columns>
           </asp:GridView> 

           <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SaleBookSystemConnectionString %>" SelectCommand="SELECT * FROM [advice]"></asp:SqlDataSource>
