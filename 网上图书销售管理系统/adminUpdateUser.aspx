<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminUpdateUser.aspx.cs" Inherits="网上图书销售管理系统.adminUpdateUser" %>
    ...
    <ul class="sidebar navbar-nav">
	  ...
	  <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" >
          ...
          <a class="dropdown-item active" href="adminUpdateUser.aspx">修改用户</a>
        </div>
      </li>
      <li class="nav-item">
       ...
       <form runat="server"  class = "m-auto">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="adminUpdateUser.aspx">修改用户</a>
          </li>
        ...
        <!-- Page Content -->
            <div class="input-group mb-3 justify-content-center" >
             <div class="input-group-prepend col-md-3">
              <span class="input-group-text" id="basic-addon1">用户账号</span>
              <asp:Label ID="Label_uid" runat="server" class="form-control" Text=""></asp:Label>
             </div>
             <div class="input-group-prepend col-md-3">
              <span class="input-group-text" id="basic-addon2">用户姓名</span>
              <asp:TextBox ID="TextBox_name" class="form-control" runat="server"></asp:TextBox>
             </div>
            </div>
           <div class="input-group mb-3 justify-content-center" >
             <div class="input-group-prepend col-md-3">
              <span class="input-group-text" id="basic-addon3">用户性别</span>
               <asp:DropDownList ID="DropDownList_sex" class="form-control" runat="server" DataSourceID="SqlDataSource1" DataTextField="sex" DataValueField="sex"></asp:DropDownList>
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SaleBookSystemConnectionString %>" SelectCommand="SELECT DISTINCT [sex] FROM [yonghu]"></asp:SqlDataSource>
             </div>
             <div class="input-group-prepend col-md-3">
              <span class="input-group-text" id="basic-addon4">用户生日</span>
              <asp:TextBox ID="TextBox_birthday" class="form-control" runat="server"></asp:TextBox>
             </div>
            </div>
           <div class="input-group mb-3 justify-content-center" >
             <div class="input-group-prepend col-md-3">
              <span class="input-group-text" id="basic-addon5">用户密码</span>
              <asp:TextBox ID="TextBox_password" class="form-control" runat="server"></asp:TextBox>
             </div>
             <div class="input-group-prepend col-md-3">
              <span class="input-group-text" id="basic-addon6">用户电话</span>
              <asp:TextBox ID="TextBox_tel" class="form-control" runat="server"></asp:TextBox>
             </div>
            </div>
           <div class="input-group mb-3 justify-content-center" >
             <div class="input-group-prepend col-md-3">
              <span class="input-group-text" id="basic-addon7">用户地址</span>
